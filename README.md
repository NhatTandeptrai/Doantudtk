...
### ⚙️ Xử lý sai số và Partial Pivoting
...
## 3. Hướng dẫn sử dụng
### Cài đặt yêu cầu
1. Mở `analysis.ipynb` và chạy cell đầu tiên để cài đặt các thư viện cần thiết.
2. Chỉ cần chạy các cells còn lại để xem kết quả.
